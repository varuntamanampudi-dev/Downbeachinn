...
function Counter({ value, onChange, min, max, label }: {
...
export default function ASIBookingForm() {
  ...
  return (
    <div className="glass-card" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      {/* Nights indicator */}
      {nights > 0 && (
        <div style={{ background: 'var(--color-teal-50)', border: '1px solid rgba(13,148,136,0.25)', borderRadius: 'var(--radius-md)', padding: '0.6rem 1rem', fontSize: '0.85rem', color: 'var(--color-teal)', fontWeight: 600, textAlign: 'center' }}>
